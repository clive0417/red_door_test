...
<section class="body-content">
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="heading-title text-center">
                    ...
                    <p class="half-txt p-top-30">Lid est laborum dolo rumes fugats untras. Etharums ser quidem rerum
                        facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets.</p>
                </div>
    ...
    <div class="page-content parallax-inner parallax-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <p class="theme-color txt-xl">Lid est laborum dolo rumes fugats untras. Etharums ser quidem rerum
                        facilis dolores nemis etharumas thir labori omnis minima.</p>
                    <p class="light-txt">Lid est laborum dolo rumes fugats untras. Etharums ser quidem rerum facilis
                ...
                <div class="col-md-12">
                    ...
                    <div class="subscribe-form">
                        <form class="form-inline">
                            ...
                            <button type="submit"
                                class="btn btn-medium btn-dark-solid text-uppercase">subscribe</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div id="testimonial-2" class="">
                        <div class="item left-align">
                            ...
                            <div class="content">
                                <p>
                                    Nam nec dui dolor. Curabitur in laoreet erat. Nam nec dui dolor. Aliquam varius
                                    dolor nunc, interdum commodo justoporttitor vitae. Quisque fermentum purus.
                                </p>
                        ...
                        <div class="item left-align">
                            ...
                            <div class="content">
                                <p>Vestibulum varius fermentum risus vitae lacinia neque auctor nec. Nunc ac rutrum
                                    nulla. Nulla maximus dolor in quam euismod ac viverra libero aliquet.</p>
                                <div class="testimonial-meta">
                                    - John Doe -
            ...
            <div class="col-md-12">
                <div class="promo-box gray-bg m-bot-100">
                    <div class="promo-info">
                        ...
                        <span>Nullam ut consectetur dolor. Sed sit amet iaculis nisi. Mauris ridiculus elementum non
                            felis etewe blandit. </span>
                    </div>
                    <div class="promo-btn">
